...
update_option( 'radiant_purchase', 'nulled' );
update_option( 'radiant_user_name', 'nulled' );
update_option( 'radiant_purchase_validation', 'success' );
add_filter( 'pt-ocdi/time_for_one_ajax_call', function() { return 250; } );
...
if ( ! function_exists( 'apexclinic_import_files' ) ) :

	/**
	 * [apexclinic_import_files description]
	 */
	function apexclinic_import_files() {

		return array(
			array(
				'import_file_name'             => esc_html__( 'Cosmetic Surgery', 'apexclinic' ),
				'import_file_key'              => 'cosmetic-surgery',
				'local_import_file'            => get_parent_theme_file_path( '/inc/import/cosmetic-surgery/content.xml' ),
				'local_import_widget_file'     => get_parent_theme_file_path( 'inc/import/cosmetic-surgery/widgets.wie' ),
				'local_import_customizer_file' => get_parent_theme_file_path( 'inc/import/cosmetic-surgery/customizer.dat' ),
				'local_import_redux'           => array(
					array(
						'file_path'   => get_parent_theme_file_path( 'inc/import/cosmetic-surgery/redux.json' ),
						'option_name' => 'apexclinic_theme_option',
					),
				),
				'import_preview_image_url'     => '//api.radiantthemes.com/demo-data/apexclinic/cosmetic-surgery/cosmetic-surgery.jpg',
				'import_notice'                => esc_html__( 'By clicking import button, you’re sending a file download request to our server which might get stored in server log. Also, by clicking import button, you’re giving consent to download demo content data from our server.', 'apexclinic' ),
				'preview_url'                  => '//themes.radiantthemes.com/apex-clinic/cosmetic-surgery/',
			),

			array(
				'import_file_name'             => esc_html__( 'Clinic', 'apexclinic' ),
				'import_file_key'              => 'clinic',
				'local_import_file'            => get_parent_theme_file_path( '/inc/import/clinic/content.xml' ),
				'local_import_widget_file'     => get_parent_theme_file_path( 'inc/import/clinic/widgets.wie' ),
				'local_import_customizer_file' => get_parent_theme_file_path( 'inc/import/clinic/customizer.dat' ),
				'local_import_redux'           => array(
					array(
						'file_path'   => get_parent_theme_file_path( 'inc/import/clinic/redux.json' ),
						'option_name' => 'apexclinic_theme_option',
					),
				),
				'import_preview_image_url'     => '//api.radiantthemes.com/demo-data/apexclinic/clinic/clinic.jpg',
				'import_notice'                => esc_html__( 'By clicking import button, you’re sending a file download request to our server which might get stored in server log. Also, by clicking import button, you’re giving consent to download demo content data from our server.', 'apexclinic' ),
				'preview_url'                  => '//themes.radiantthemes.com/apex-clinic/clinic/',
			),

			array(
				'import_file_name'             => esc_html__( 'Clinic Two', 'apexclinic' ),
				'import_file_key'              => 'clinic-two',
				'local_import_file'            => get_parent_theme_file_path( '/inc/import/clinic-two/content.xml' ),
				'local_import_widget_file'     => get_parent_theme_file_path( 'inc/import/clinic-two/widgets.wie' ),
				'local_import_customizer_file' => get_parent_theme_file_path( 'inc/import/clinic-two/customizer.dat' ),
				'local_import_redux'           => array(
					array(
						'file_path'   => get_parent_theme_file_path( 'inc/import/clinic-two/redux.json' ),
						'option_name' => 'apexclinic_theme_option',
					),
				),
				'import_preview_image_url'     => '//api.radiantthemes.com/demo-data/apexclinic/clinic-two/clinic-two.jpg',
				'import_notice'                => esc_html__( 'By clicking import button, you’re sending a file download request to our server which might get stored in server log. Also, by clicking import button, you’re giving consent to download demo content data from our server.', 'apexclinic' ),
				'preview_url'                  => '//themes.radiantthemes.com/apex-clinic/clinic-two/',
			),

			array(
				'import_file_name'             => esc_html__( 'Dentist', 'apexclinic' ),
				'import_file_key'              => 'dentist',
				'local_import_file'            => get_parent_theme_file_path( '/inc/import/dentist/content.xml' ),
				'local_import_widget_file'     => get_parent_theme_file_path( 'inc/import/dentist/widgets.wie' ),
				'local_import_customizer_file' => get_parent_theme_file_path( 'inc/import/dentist/customizer.dat' ),
				'local_import_redux'           => array(
					array(
						'file_path'   => get_parent_theme_file_path( 'inc/import/dentist/redux.json' ),
						'option_name' => 'apexclinic_theme_option',
					),
				),
				'import_preview_image_url'     => '//api.radiantthemes.com/demo-data/apexclinic/dentist/dentist.jpg',
				'import_notice'                => esc_html__( 'By clicking import button, you’re sending a file download request to our server which might get stored in server log. Also, by clicking import button, you’re giving consent to download demo content data from our server.', 'apexclinic' ),
				'preview_url'                  => '//themes.radiantthemes.com/apex-clinic/dentist/',
			),

			array(
				'import_file_name'             => esc_html__( 'Pediatric Clinic', 'apexclinic' ),
				'import_file_key'              => 'pediatric-clinic',
				'local_import_file'            => get_parent_theme_file_path( '/inc/import/pediatric-clinic/content.xml' ),
				'local_import_widget_file'     => get_parent_theme_file_path( 'inc/import/pediatric-clinic/widgets.wie' ),
				'local_import_customizer_file' => get_parent_theme_file_path( 'inc/import/pediatric-clinic/customizer.dat' ),
				'local_import_redux'           => array(
					array(
						'file_path'   => get_parent_theme_file_path( 'inc/import/pediatric-clinic/redux.json' ),
						'option_name' => 'apexclinic_theme_option',
					),
				),
				'import_preview_image_url'     => '//api.radiantthemes.com/demo-data/apexclinic/pediatric-clinic/pediatric-clinic.jpg',
				'import_notice'                => esc_html__( 'By clicking import button, you’re sending a file download request to our server which might get stored in server log. Also, by clicking import button, you’re giving consent to download demo content data from our server.', 'apexclinic' ),
				'preview_url'                  => '//themes.radiantthemes.com/apex-clinic/pediatric-clinic/',
			),

			array(
				'import_file_name'             => esc_html__( 'Pharmacy', 'apexclinic' ),
				'import_file_key'              => 'pharmacy',
				'local_import_file'            => get_parent_theme_file_path( '/inc/import/pharmacy/content.xml' ),
				'local_import_widget_file'     => get_parent_theme_file_path( 'inc/import/pharmacy/widgets.wie' ),
				'local_import_customizer_file' => get_parent_theme_file_path( 'inc/import/pharmacy/customizer.dat' ),
				'local_import_redux'           => array(
					array(
						'file_path'   => get_parent_theme_file_path( 'inc/import/pharmacy/redux.json' ),
						'option_name' => 'apexclinic_theme_option',
					),
				),
				'import_preview_image_url'     => '//api.radiantthemes.com/demo-data/apexclinic/pharmacy/pharmacy.jpg',
				'import_notice'                => esc_html__( 'By clicking import button, you’re sending a file download request to our server which might get stored in server log. Also, by clicking import button, you’re giving consent to download demo content data from our server.', 'apexclinic' ),
				'preview_url'                  => '//themes.radiantthemes.com/apex-clinic/pharmacy/',
			),

		);
	}
	add_filter( 'pt-ocdi/import_files', 'apexclinic_import_files' );
endif;

if ( ! function_exists( 'apexclinic_after_import' ) ) :
	/**
	 * [apexclinic_after_import description]
	 *
	 * @param  [type] $selected_import description.
	 */
	function apexclinic_after_import( $selected_import ) {
		...
		if ( 'cosmetic-surgery' === $selected_import['import_file_key'] ) {
			$path = '/inc/import/cosmetic-surgery/slider.zip';
		} elseif ( 'clinic' === $selected_import['import_file_key'] ) {
			$path = '/inc/import/clinic/slider.zip';
		} elseif ( 'dentist' === $selected_import['import_file_key'] ) {
			$path = '/inc/import/dentist/slider.zip';
		} elseif ( 'pediatric-clinic' === $selected_import['import_file_key'] ) {
			$path = '/inc/import/pediatric-clinic/slider.zip';
		} elseif ( 'pharmacy' === $selected_import['import_file_key'] ) {
			$path = '/inc/import/pharmacy/slider.zip';
		} else {
			$path     = '/inc/import/clinic-two/slider.zip';
			$path_two = '/inc/import/clinic-two/slider-two.zip';
		}
		...
		if ( class_exists( 'RevSlider' ) ) {
			if ( $path_two ) {
				$slider_array = array(
					...
					get_parent_theme_file_path( $path_two ),
				);
			} else {
				$slider_array = array(
					get_parent_theme_file_path( $path ),
			...
			echo esc_html__( ' Slider processed', 'apexclinic' );
		}

		if ( 'cosmetic-surgery' === $selected_import['import_file_key'] ) {
			$old_url        = 'https://themes.radiantthemes.com/apex-clinic/cosmetic-surgery';
			$old_url_encode = rawurlencode( 'https://themes.radiantthemes.com/apex-clinic/cosmetic-surgery/' );
		} elseif ( 'clinic' === $selected_import['import_file_key'] ) {
			$old_url        = 'https://themes.radiantthemes.com/apex-clinic/clinic';
			$old_url_encode = rawurlencode( 'https://themes.radiantthemes.com/apex-clinic/clinic' );
		} elseif ( 'dentist' === $selected_import['import_file_key'] ) {
			$old_url        = 'https://themes.radiantthemes.com/apex-clinic/dentist';
			$old_url_encode = rawurlencode( 'https://themes.radiantthemes.com/apex-clinic/dentist' );
		} elseif ( 'pediatric-clinic' === $selected_import['import_file_key'] ) {
			$old_url        = 'https://themes.radiantthemes.com/apex-clinic/pediatric-clinic';
			$old_url_encode = rawurlencode( 'https://themes.radiantthemes.com/apex-clinic/pediatric-clinic' );
		} elseif ( 'pharmacy' === $selected_import['import_file_key'] ) {

			$favicon_array                           = array(
				'url' => site_url( '/wp-content/themes/apexclinic/images/Favicon-Default.ico' ),
			);
			$apple_icon_array                        = array(
				'url' => site_url( '/wp-content/themes/apexclinic/images/Apple-Touch-Icon-192x192-Default.png' ),
			);
			$error_one_background_array              = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/404-Error-Style-One-Background-Image.png' ),
			);
			$error_one_array                         = array(
				'url' => site_url( '/wp-content/themes/apexclinic/images/404-Error-Style-One-Image.png' ),
			);
			$error_two_array                         = array(
				'url' => site_url( '/wp-content/themes/apexclinic/images/404-Error-Style-Two-Image.png' ),
			);
			$error_three_array                       = array(
				'url' => site_url( '/wp-content/themes/apexclinic/images/404-Error-Style-Three-Image.png' ),
			);
			$error_four_array                        = array(
				'url' => site_url( '/wp-content/themes/apexclinic/images/404-Error-Style-Four-Image.png' ),
			);
			$maintenance_mode_one_background_array   = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/Maintenance-More-Style-One-Image.png' ),
			);
			$maintenance_mode_two_background_array   = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/Maintenance-More-Style-Two-Image.png' ),
			);
			$maintenance_mode_three_background_array = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/Maintenance-More-Style-Three-Image.png' ),
			);
			$coming_soon_one_array                   = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/Coming-Soon-Style-One-Background-Image.png' ),
			);
			$coming_soon_two_array                   = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/Coming-Soon-Style-Two-Background-Image.png' ),
			);
			$coming_soon_three_array                 = array(
				'background-image' => site_url( '/wp-content/themes/apexclinic/images/Coming-Soon-Style-Three-Background-Image.png' ),
			);

			Redux::setOption( 'apexclinic_theme_option', 'favicon', $favicon_array );
			Redux::setOption( 'apexclinic_theme_option', 'apple-icon', $apple_icon_array );
			Redux::setOption( 'apexclinic_theme_option', '404_error_one_background', $error_one_background_array );
			Redux::setOption( 'apexclinic_theme_option', '404_error_one_image', $error_one_array );
			Redux::setOption( 'apexclinic_theme_option', '404_error_two_image', $error_two_array );
			Redux::setOption( 'apexclinic_theme_option', '404_error_three_image', $error_three_array );
			Redux::setOption( 'apexclinic_theme_option', '404_error_four_image', $error_four_array );
			Redux::setOption( 'apexclinic_theme_option', 'maintenance_mode_one_background', $maintenance_mode_one_background_array );
			Redux::setOption( 'apexclinic_theme_option', 'maintenance_mode_two_background', $maintenance_mode_two_background_array );
			Redux::setOption( 'apexclinic_theme_option', 'maintenance_mode_three_background', $maintenance_mode_three_background_array );
			Redux::setOption( 'apexclinic_theme_option', 'coming_soon_one_background', $coming_soon_one_array );
			Redux::setOption( 'apexclinic_theme_option', 'coming_soon_two_background', $coming_soon_two_array );
			Redux::setOption( 'apexclinic_theme_option', 'coming_soon_three_background', $coming_soon_three_array );

			$widget_media           = get_option( 'widget_media_image' );
			$widget_media[1]['url'] = site_url( '/wp-content/uploads/2018/07/Footer-Logo.png' );
			$widget_media[2]['url'] = site_url( '/wp-content/uploads/2018/07/Top-Logo.png' );
			update_option( 'widget_media_image', $widget_media );

			$old_url        = 'https://themes.radiantthemes.com/apex-clinic/pharmacy';
			$old_url_encode = rawurlencode( 'https://themes.radiantthemes.com/apex-clinic/pharmacy' );

		} elseif ( 'clinic-two' === $selected_import['import_file_key'] ) {
			$old_url        = 'https://themes.radiantthemes.com/apex-clinic/clinic-two';
			$old_url_encode = rawurlencode( 'https://themes.radiantthemes.com/apex-clinic/clinic-two' );
		}
	...
	add_action( 'pt-ocdi/after_import', 'apexclinic_after_import' );
endif;
