...
$opt_name = 'apexclinic_theme_option';
...
$args  = array(
	...
	'display_version'      => esc_html__( 'Powered By: RadiantThemes Customizer', 'apexclinic' ),
	'menu_type'            => 'menu',
	'allow_sub_menu'       => true,
	'menu_title'           => esc_html__( 'Theme Options', 'apexclinic' ),
	'page_title'           => esc_html__( 'Theme Options', 'apexclinic' ),
	'google_api_key'       => '',
...
Redux::setSection(
	$opt_name, array(
		'title' => esc_html__( 'General', 'apexclinic' ),
		'icon'  => 'el el-cog',
		'id'    => 'theme-general',
	)
);
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Layout', 'apexclinic' ),
		'icon'       => 'el el-screen',
		'id'         => 'layout',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				'id'    => 'info_layout',
				'type'  => 'info',
				'title' => esc_html__( 'Layout Options', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
			...
			array(
				'id'       => 'layout_type',
				'type'     => 'select',
				'title'    => esc_html__( 'Layout Type', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select layout type. (Please Note: Please set "Row stretch" to "Default" from WPBakery Page Builder "Row Settings"/"Section Settings" for "Boxed" layout.)', 'apexclinic' ),
				'options'  => array(
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Boxed Width', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select Boxed width. Min is 1000px, Max is 1400px and Default is 1200px.', 'apexclinic' ),
				'min'           => 1000,
				'step'          => 10,
				'max'           => 1400,
				'default'       => 1200,
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Boxed Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for Boxed layout. (Please Note: This can be overright by setting section background color.)', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Body Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose a background for the theme. (Please Note: This can be overright by setting section background color.)', 'apexclinic' ),
				'default'  => array(
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Color', 'apexclinic' ),
		'icon'       => 'el el-brush',
		'id'         => 'color',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Color Options', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Color Scheme Type', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select color scheme type', 'apexclinic' ),
				'options'  => array(
			...
			array(
                ...
                'type'     => 'palette',
                'title'    => esc_html__( 'Select Theme Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'From here you can choose theme color for your website. (Please Note: This will set preset color scheme on your theme. You can replace color(s) from each element settings.)', 'apexclinic' ),
                'palettes' => array(
                    '#1d4fce'     => array(
                        '#1d4fce',
                    ),
			...
			array(
				...
				'title'    => esc_html__( 'Select Theme Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'From here you can choose theme color for your website. (Please Note: This will set preset color scheme on your theme. You can replace color(s) from each element settings.)', 'apexclinic' ),
				'desc'     => esc_html__( 'Select alpha value if you want to use alpha in selected areas.', 'apexclinic' ),
				'default'  => array(
					'color'  => '#2b65eb',
					'alpha'  => 0.85,
				),
...
Redux::setSection(
	$opt_name, array(
		'title'  => esc_html__( 'Favicon', 'apexclinic' ),
		'id'     => 'favicon',
		...
		'fields' => array(
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( 'Favicon', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can upload Favicon on your website. (.ico 32x32 pixels)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				'id'    => 'apple-icon',
				'type'  => 'media',
				'title' => esc_html__( 'Apple Touch Icon', 'apexclinic' ),
				'desc'  => esc_html__( 'apple-touch-icon.png 192x192 pixels', 'apexclinic' ),
				'default'  => array(
...
Redux::setSection(
	$opt_name, array(
		'title'   => esc_html__( 'Fonts', 'apexclinic' ),
		'id'      => 'basic-settings',
		'icon'    => 'el el-fontsize',
		'subsection' => true,
		'fields'  => array(
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'General', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'text-transform' => true,
			...
			array(
				'id'             => 'h1_typography',
				'type'           => 'typography',
				'title'          => esc_html__( 'H1', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font for all H1 tags of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'font-weight'    => true,
			...
			array(
				'id'             => 'h2_typography',
				'type'           => 'typography',
				'title'          => esc_html__( 'H2', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font for all H2 tags of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'font-weight'    => true,
			...
			array(
				'id'             => 'h3_typography',
				'type'           => 'typography',
				'title'          => esc_html__( 'H3', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font for all H3 tags of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'font-weight'    => true,
			...
			array(
				'id'             => 'h4_typography',
				'type'           => 'typography',
				'title'          => esc_html__( 'H4', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font for all H4 tags of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'font-weight'    => true,
			...
			array(
				'id'             => 'h5_typography',
				'type'           => 'typography',
				'title'          => esc_html__( 'H5', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font for all H5 tags of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'font-weight'    => true,
			...
			array(
				'id'             => 'h6_typography',
				'type'           => 'typography',
				'title'          => esc_html__( 'H6', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font for all H6 tags of your website.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'font-weight'    => true,
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Custom Slug', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				'id'    => 'info_change_slug',
				'type'  => 'info',
				'title' => esc_html__( 'Change Custom Post Type Slug', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Portfolio', 'apexclinic' ),
				'subtitle' => esc_html__( 'The slug name cannot be the same as a page name. Make sure to regenerate permalinks, after making changes.', 'apexclinic' ),
			...
			array(
				'id'       => 'change_slug_team',
				'type'     => 'text',
				'title'    => esc_html__( 'Team', 'apexclinic' ),
				'subtitle' => esc_html__( 'The slug name cannot be the same as a page name. Make sure to regenerate permalinks, after making changes.', 'apexclinic' ),
				'validate' => 'no_special_chars',
				'default'  => 'team',
			),
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Case Study', 'apexclinic' ),
				'subtitle' => esc_html__( 'The slug name cannot be the same as a page name. Make sure to regenerate permalinks, after making changes.', 'apexclinic' ),
				'validate' => 'no_special_chars',
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Preloader', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				'id'    => 'info_preloader',
				'type'  => 'info',
				'title' => esc_html__( 'Preloader Options', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			...
			array(
				'id'       => 'preloader_switch',
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate Preloader', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if want to activate Preloader or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				'id'       => 'preloader_style',
				'type'     => 'select',
				'title'    => esc_html__( 'Preloader Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Style of the Preloader. (Powered By: "SpinKit")', 'apexclinic' ),
				'options'  => array(
			...
			array(
				'id'       => 'preloader_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Preloader Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a color for the Preloader.', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Preloader Timeout', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select preloader timeout after successful page load. Min is 100ms, Max is 3000ms and Default is 500ms.', 'apexclinic' ),
				'min'           => 100,
				'step'          => 100,
				'max'           => 3000,
				'default'       => 500,
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Page Transition', 'apexclinic' ),
		'icon'       => 'el el-magic',
		'id'    	 => 'page_transition',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Page Transition Options', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate Page Transition', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if want to activate Page Transition or not. (Please Note: Preloader option will not work if you enable this.)', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a color for the Page Transition.', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Loader Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a color for the Page Transition Loader.', 'apexclinic' ),
				'default'  => array(
					'color' => '#0abc5f',
					'alpha' => 1,
				),
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Scroll To Top', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Scroll To Top Options', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate Scroll To Top', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if want to activate Scroll To Top or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Direction', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Direction of the Scroll To Top.', 'apexclinic' ),
				'options'  => array(
					'left'    => 'Left',
					'right'   => 'Right',
				),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Scroll To Top.', 'apexclinic' ),
				'output'   => array(
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'GDPR Notice', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				'id'    => 'info_gdpr_notice',
				'type'  => 'info',
				'title' => esc_html__( 'GDPR Notice Options', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate GDPR Notice', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if want to activate GDPR Notice or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the GDPR Notice.', 'apexclinic' ),
				'default'  => array(
					'color' => '#3b4354',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'GDPR Notice Typography', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font of GDPR Notice.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'text-transform' => true,
			...
			array(
				...
				'type'     => 'textarea',
				'title'    => esc_html__( 'GDPR Notice Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on GDPR Notice.', 'apexclinic' ),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'GDPR Notice Button Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Button Text for GDPR Notice button.', 'apexclinic' ),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'GDPR Notice Button Link', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Button Link for GDPR Notice button.', 'apexclinic' ),
				'default'  => '#',
				'required'      => array(
					array(
						'gdpr_notice_switch',
...
Redux::setSection(
	$opt_name, array(
		'title' => esc_html__( 'Header', 'apexclinic' ),
		'icon'  => 'el el-website',
		'id'    => 'header',
	)
);
	...
	$opt_name, array(
		...
		'fields'     => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Style', 'apexclinic' ),
				'style' => 'custom',
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
			),
			...
			array(
				'id'    => 'header_cart_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Cart Settings', 'apexclinic' ),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Cart Icon', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "cart" icon in header or not. (Please Note: Header "Style Default" will not work with this option.)', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Default Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),

			// Header Default Header Top Background Color.
			array(
				'id'       => 'header_default_header_top_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Top Header Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for top header. (Applies for header "Style Default" only)', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
				'output'   => array(
					'background-color' => '.wraper_header.style-default .wraper_header_top',
				),
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Main Header Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for main header. (Applies for header "Style Default" only)', 'apexclinic' ),
				'default'  => array(
					'color' => '#14a09d',
					'alpha' => 1,
				),
			...
			array(
				'id'    => 'header_one_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header One Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Floating Option', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want the header to be floated (position:absolute) or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Main Header Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for main header.', 'apexclinic' ),
				'default'  => array(
					'color' => '#000000',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Main Header Border Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for main header.', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 0.2,
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Sticky Option', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want the header to be "Sticky" or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Main Header Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for main header when it is sticky.', 'apexclinic' ),
				'default'  => array(
					'color' => '#000000',
					'alpha' => 0.85,
				),
			...
			array(
				'id'       => 'header_one_logo',
				'type'     => 'media',
				'title'    => esc_html__( 'Logo', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can upload logo on your website.', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( 'Retina Logo', 'apexclinic' ),
				'subtitle' => esc_html__( 'Retina Logo should be 2x larger than original Logo. Your logo name should be "your existing logo name on "Logo" field@2x.your existing logo extension on "Logo" field". For example, if your "Logo" name is "logo.png", then your Retina logo name should be "logo@2x.png".', 'apexclinic' ),
			),
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'Menu Typography', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Typography options for Menu.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => false,
				'subsets'        => false,
				'text-align'     => false,
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'Submenu Typography', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Typography options for Submenu.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => false,
				'subsets'        => false,
				'text-align'     => true,
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Menu Hover Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for all menu items.', 'apexclinic' ),
				'validate' => 'color',
				'output'   => array(
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Search Icon / Mobile Menu Icon / Cart Icon / Hamburger Icon Size', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select action button size. Min is 15px, Max is 50px and Default is 17px.', 'apexclinic' ),
				'min'           => 15,
				'step'          => 1,
				'max'           => 50,
				'default'       => 17,
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Cart Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select cart icon color.', 'apexclinic' ),
				'validate' => 'color',
				'default'  => '#ffffff',
				'output'   => array(
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Search', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "Search" option in header or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Search Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select search icon color.', 'apexclinic' ),
				'validate' => 'color',
				'default'  => '#ffffff',
				'output'   => array(
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Select Search Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Style of the "Search".', 'apexclinic' ),
				'options'  => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Choose Search Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies only for "Flyout Search".', 'apexclinic' ),
				'required' => array(
					array(
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Hamburger Menu', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "Hamburger" option in header or not. You add/remove widgets of "Hamburger" from "Appearance > Widgets".', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Hamburger Menu On Mobile', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "Hamburger" option on mobile or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
				'required' => array(
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Select Hamburger Menu Icon', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Style of the Hamburger Menu Icon.', 'apexclinic' ),
				'options'  => array(
					'ellipsis'         => 'Ellipsis',
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Hamburger Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select hamburger icon color.', 'apexclinic' ),
				'validate' => 'color',
				'default'  => '#ffffff',
				'output'   => array(
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Hamburger Menu Width', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select hamburger menu width. Min is 200px, Max is 800px and Default is 600px.', 'apexclinic' ),
				'min'           => 200,
				'step'          => 10,
				'max'           => 800,
				'default'       => 600,
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Hamburger Menu Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for hamburger menu.', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#ffffff',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Mobile Menu Menu', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "Mobile Menu" option in header or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Mobile Menu Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select mobile menu icon color.', 'apexclinic' ),
				'validate' => 'color',
				'default'  => '#838383',
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Mobile Menu Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for mobile menu only.', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'Mobile Menu Typography', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Typography options for mobile menu.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => false,
				'subsets'        => false,
				'text-align'     => false,
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Mobile Menu Inner Close Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for mobile menu only.', 'apexclinic' ),
				'validate' => 'color',
				'default'  => '#838383',
				'output'   => array(
			...
			array(
				'id'    => 'header_two_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Two Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Hamburger Menu Width', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select hamburger menu width. Min is 200px, Max is 800px and Default is 460px.', 'apexclinic' ),
				'min'           => 200,
				'step'          => 10,
				'max'           => 800,
				'default'       => 460,
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Three Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Top Header Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for top header.', 'apexclinic' ),
				'default'  => array(
					'color' => '#244e7d',
					'alpha' => 1,
				),
			...
			// Header Three Header Top Tag.
			array(
				'id'       => 'header_three_header_top_tag',
				'type'     => 'text',
				'title'    => esc_html__( 'Header Tag', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Three" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Join our team. Are you ready to grow up your business?', 'apexclinic' ),
			),
			...
			// Header Three Header Contact Phone Text.
			array(
				'id'       => 'header_three_header_top_phone_text',
				'type'     => 'text',
				'title'    => esc_html__( 'Contact Phone Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Three" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Need Help? Call Us', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Phone', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Three" only.', 'apexclinic' ),
				'default'  => esc_html__( '888-123-4567', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'header_four_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Four Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( 'Logo', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can upload logo on your website. (Applies for header "Style Four" only.)', 'apexclinic' ),
			),
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Search Icon / Mobile Menu Icon / Cart Icon / Hamburger Icon Size', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select action button size. Min is 15px, Max is 50px and Default is 20px.', 'apexclinic' ),
				'min'           => 15,
				'step'          => 1,
				'max'           => 50,
				'default'       => 20,
			...
			array(
				'id'    => 'header_five_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Five Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				'id'    => 'header_six_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Six Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				'id'       => 'header_six_menu',
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Menu', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want to display menu or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Menu Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select menu icon color.', 'apexclinic' ),
				'validate' => 'color',
				'default'  => '#ffffff',
				'output'   => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Seven Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Eight Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Action Button Size', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select action button size. Min is 15px, Max is 50px and Default is 20px.', 'apexclinic' ),
				'min'           => 15,
				'step'          => 1,
				'max'           => 50,
			...
			array(
				'id'    => 'header_nine_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Nine Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				'id'       => 'header_nine_header_main_contact_email_text',
				'type'     => 'text',
				'title'    => esc_html__( 'Contact Email Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Nine" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Get in Touch', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Email', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Nine" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Email Us: info@example.com', 'apexclinic' ),
			),
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Search Icon / Cart Icon Icon Size', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select action button size. Min is 15px, Max is 50px and Default is 17px.', 'apexclinic' ),
				'min'           => 15,
				'step'          => 1,
				'max'           => 50,
			...
			array(
				'id'    => 'header_ten_info',
				'type'  => 'info',
				'title' => esc_html__( 'Header Ten Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			// Header Ten Header Top Contact Phone Text.
			array(
				'id'       => 'header_ten_header_top_contact_phone_text',
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Phone Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Ten" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Emergency Help', 'apexclinic' ),
			),
			...
			// Header Ten Header Top Contact Address.
			array(
				'id'       => 'header_ten_header_top_contact_address',
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Email', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Ten" only.', 'apexclinic' ),
				'default'  => esc_html__( 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia', 'apexclinic' ),
			),

			// Header Ten Header Top Contact Timing.
			array(
				'id'       => 'header_ten_header_top_contact_timing',
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Email', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Ten" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Monday - Saturday - 8:00 - 18:00 <br> Sunday - 8:00 - 14:00', 'apexclinic' ),
			),
			...
			array(
				...
				'type'          => 'slider',
				'title'         => esc_html__( 'Search Icon / Mobile Menu Icon / Cart Icon / Hamburger Icon Size', 'apexclinic' ),
				'subtitle'      => esc_html__( 'Select action button size. Min is 15px, Max is 50px and Default is 18px.', 'apexclinic' ),
				'min'           => 15,
				'step'          => 1,
				'max'           => 50,
				'default'       => 18,
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Eleven Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Action Button One', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "Action Button One" option in header or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Action Button One Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for Action Button One.', 'apexclinic' ),
				'default'  => array(
					'color' => '#4eafcb',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Action Button One Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Eleven" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Send Free Trial', 'apexclinic' ),
				'required' => array(
					array(
						'header_eleven_action_button_one_display',
						'equals',
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Action Button One Link', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Eleven" only.', 'apexclinic' ),
				'default'  => esc_html__( '#', 'apexclinic' ),
				'required' => array(
					array(
						'header_eleven_action_button_one_display',
						'equals',
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Display Action Button Two', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if you want "Action Button Two" option in header or not.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Action Button Two Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for Action Button Two.', 'apexclinic' ),
				'default'  => array(
					'color' => '#25c16f',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Action Button Two Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Eleven" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Sign Up', 'apexclinic' ),
				'required' => array(
					array(
						'header_eleven_action_button_two_display',
						'equals',
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Action Button Two Link', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Eleven" only.', 'apexclinic' ),
				'default'  => esc_html__( '#', 'apexclinic' ),
				'required' => array(
					array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Header Twelve Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			// Header Twelve Header Top Contact Phone Text.
			array(
				'id'       => 'header_twelve_header_top_contact_phone_text',
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Phone Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Twelve" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Emergency Help', 'apexclinic' ),
			),
			...
			// Header Twelve Header Top Contact Address.
			array(
				'id'       => 'header_twelve_header_top_contact_address',
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Email', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Twelve" only.', 'apexclinic' ),
				'default'  => esc_html__( 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia', 'apexclinic' ),
			...
			// Header Twelve Header Top Contact Timing.
			array(
				'id'       => 'header_twelve_header_top_contact_timing',
				'type'     => 'text',
				'title'    => esc_html__( 'Enter Contact Email', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies for header "Style Twelve" only.', 'apexclinic' ),
				'default'  => esc_html__( 'Monday - Saturday - 8:00 - 18:00 <br> Sunday - 8:00 - 14:00', 'apexclinic' ),
			...
			array(
				'id'       => 'header_twelve_action_button_search_icon_color',
				'type'     => 'color',
				'title'    => esc_html__( 'Search Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select search icon color.', 'apexclinic' ),
				'validate' => 'color',
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Short Header', 'apexclinic' ),
		'icon'       => 'el el-website',
		...
		'fields'     => array(
			...
			array(
				'id'       => 'short-header',
				'type'     => 'image_select',
				'title'    => esc_html__( 'Select Short Header', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose what kind of short header you want to set.', 'apexclinic' ),
				'options'  => array(
					'Banner-With-Breadcrumb'     => array(
						'alt'   => esc_html__( 'Banner-With-Breadcrumb', 'apexclinic' ),
						'img'   => get_parent_theme_file_uri( '/inc/redux-framework/css/img/banners/Banner-With-Breadcrumb.png' ),
						'title' => esc_html__( 'Banner & Breadcrumb', 'apexclinic' ),
					),
					'Banner-only'     => array(
						'alt'   => esc_html__( 'Banner Only', 'apexclinic' ),
						'img'   => get_parent_theme_file_uri( '/inc/redux-framework/css/img/banners/Banner-Only.png' ),
						'title' => esc_html__( 'Banner Only', 'apexclinic' ),
					),
					'breadcrumb-only' => array(
						'alt'   => esc_html__( 'Breadcrumb-Only', 'apexclinic' ),
						'img'   => get_parent_theme_file_uri( '/inc/redux-framework/css/img/banners/Breadcrumb-Only.png' ),
						'title' => esc_html__( 'Breadcrumb Only', 'apexclinic' ),
					),
					'banner-none'   => array(
						'alt'   => esc_html__( 'Banner None', 'apexclinic' ),
						'img'   => get_parent_theme_file_uri( '/inc/redux-framework/css/img/banners/Banner-None.png' ),
						'title' => esc_html__( 'Banner None', 'apexclinic' ),
					),
				),
				'default'  => 'Banner-only',
			),
			...
			array(
				...
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
				'title' => esc_html__( 'Inner Page Banner', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Inner Page Banner Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Inner Page Banner. (Please Note: This is the default image of Inner Page Banner section. You can change background image on respective pages.)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Inner Page Banner Border Bottom', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom for Inner Page Banner.', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'title'          => esc_html__( 'Inner Page Banner Padding', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Set padding for inner page banner area.', 'apexclinic' ),
				'all'            => false,
				'top'            => true,
				'right'          => false,
				'bottom'         => true,
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'Inner Page Banner Title Font', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font of your inner page banner title.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'text-transform' => true,
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'Inner Page Banner Subtitle Font', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font of your inner page banner subtitle.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'text-transform' => true,
			...
			array(
				...
				'type'    => 'select',
				'title'   => esc_html__( 'Inner Page Banner Alignment', 'apexclinic' ),
				'options' => array(
					'left'   => 'Left',
					'center' => 'Center',
					'right'  => 'Right',
			...
			array(
				...
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
				'title' => esc_html__( 'Breadcrumb', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'select',
				'title'    => __( 'Breadcrumb Arrow Style', 'apexclinic' ),
				'subtitle' => __( 'Select an icon for breadcrumb arrow.', 'apexclinic' ),
				'data'     => 'elusive-icons',
			...
			array(
				'id'             => 'breadcrumb_font',
				'type'           => 'typography',
				'title'          => esc_html__( 'Inner Page Banner Breadcrumb Font', 'apexclinic' ),
				'subtitle'       => esc_html__( 'This will be the default font of your Inner Page Banner Breadcrumb.', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => true,
				'text-align'     => false,
				'text-transform' => true,
			...
			array(
				...
				'units'          => array( 'em', 'px' ),
				'units_extended' => 'false',
				'title'          => esc_html__( 'Breadcrumb Padding', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Set padding for breadcrumb area.', 'apexclinic' ),
				'all'            => false,
				'top'            => true,
				'right'          => false,
				'bottom'         => true,
			...
			array(
				...
				'type'    => 'select',
				'title'   => esc_html__( 'Breadcrumb Alignment', 'apexclinic' ),
				'options' => array(
					'left'   => 'Left',
					'center' => 'Center',
					'right'  => 'Right',
...
Redux::setSection(
	$opt_name, array(
		'title'  => esc_html__( 'Footer', 'apexclinic' ),
		'icon'   => 'el el-photo',
		'id'     => 'footer',
		'fields' => array(
			...
			array(
				...
				'color' => '#b9cbe4',
				'class' => 'radiant-subheader',
				'title' => esc_html__( 'Footer Style', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'image_select',
				'title'    => esc_html__( 'Footer Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select footer style. (N.B.: Please set style for individual footer on their respective settings below.)', 'apexclinic' ),
				'options'  => array(
			...
			array(
				'id'    => 'footer_one_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer One Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style One".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style One".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style One".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style One".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style One".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'footer_two_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer Two Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Two".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Two".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Two".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Two".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Two".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Footer Three Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Three".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Three".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Three".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Three".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Three".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'footer_four_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer Four Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Four".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Navigation Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Navigation. (Applicable only for footer "Style Four".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#00174d',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Four".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Four".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Four".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Four".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'footer_five_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer Five Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Five".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Navigation Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Navigation. (Applicable only for footer "Style Five".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#00174d',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Five".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Five".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Five".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Five".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'footer_six_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer Six Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Six".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Six".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Six".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 0.3,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Six".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Six".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Footer Seven Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Seven".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Seven".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Footer Eight Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( 'Copyright Logo', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can upload logo on your copyright section of footer. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Contact Address', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Contact Address. (Applicable only for footer "Style Eight".)', 'apexclinic' ),
				'default'  => esc_html__( '123, XYZ Road, Collins Avn., New York', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'footer_nine_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer Nine Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Nine".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Navigation Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Navigation. (Applicable only for footer "Style Nine".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#00174d',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Nine".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Nine".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Nine".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Nine".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'footer_ten_info',
				'type'  => 'info',
				'title' => esc_html__( 'Footer Ten Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Ten".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#161616',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Ten".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Bottom Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Border Bottom Color for Footer Main section. (Applicable only for footer "Style Ten".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#fff',
					'alpha' => 0.01,
				),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Ten".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Ten".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Footer Eleven Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Footer. (Applicable only for footer "Style Eleven".)', 'apexclinic' ),
				'default'  => array(
					'background-color' => '#14a09d',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Main Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Main Section. (Applicable only for footer "Style Eleven".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			// Footer Eleven Main Border Color.
			array(
				'id'       => 'footer_eleven_main_border_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Footer Main Border Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a border bottom color for the Footer Main Section. (Applicable only for footer "Style Eleven".)', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 0.3,
				),
				'output'   => array(
					'border-bottom-color' => '.wraper_footer.style-eleven .wraper_footer_main',
				),
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Footer Copyright Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for the Footer Copyright Background. (Applicable only for footer "Style Eleven".)', 'apexclinic' ),
				'default'  => array(
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Copyright Text. (Applicable only for footer "Style Eleven".)', 'apexclinic' ),
				'default'  => esc_html__( 'apexclinic - 2018', 'apexclinic' ),
			),
...
Redux::setSection(
	$opt_name, array(
		'title' => esc_html__( 'Elements', 'apexclinic' ),
		'icon'  => 'el el-braille',
		'id'    => 'elements',
	)
);
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Scroll Bar', 'apexclinic' ),
		'id'         => 'scroll_bar',
		...
		'fields'     => array(
			...
			array(
				'id'       => 'scrollbar_switch',
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate Custom Scrollbar', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if Custom Scrollbar will be activate or not. (Please Note: This will take effect on infinity scroll areas but not for entire website.)', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				'id'       => 'scrollbar_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Scroll Bar Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a color for Scroll Bar.', 'apexclinic' ),
				'required' => array(
					array(
						'scrollbar_switch',
						'equals',
			...
			array(
				...
				'units'    => array( 'em', 'px' ),
				'height'   => false,
				'title'    => esc_html__( 'Scroll Bar Width', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set width for Scroll Bar.', 'apexclinic' ),
				'required' => array(
					array(
						'scrollbar_switch',
						'equals',
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Button', 'apexclinic' ),
		'icon'       => 'el el-off',
		'id'         => 'button-style',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				...
				'units'          => array( 'em', 'px' ),
				'units_extended' => 'false',
				'title'          => esc_html__( 'Button Padding', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Allow padding for buttons.', 'apexclinic' ),
				'default'        => array(
					'padding-top'    => '12px',
					'padding-right'  => '35px',
					'padding-bottom' => '13px',
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Hover Background Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Pick a background color for buttons hover.', 'apexclinic' ),
				'default'  => array(
					'color' => '#252525',
					'alpha' => 1,
				),
			...
			array(
				'id'      => 'button_border',
				'type'    => 'border',
				'title'   => esc_html__( 'Border', 'apexclinic' ),
				'default' => array(
					'border-top'    => '0px',
					'border-right'  => '0px',
					'border-bottom' => '0px',
			...
			array(
				...
				'type'    => 'border',
				'title'   => esc_html__( 'Hover Border Color', 'apexclinic' ),
				'default' => array(
					'border-top'    => '0px',
					'border-right'  => '0px',
					'border-bottom' => '0px',
			...
			array(
				...
				'units'          => array( 'em', 'px' ),
				'units_extended' => 'false',
				'title'          => esc_html__( 'Border Radius', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Users can change the Border Radius for Buttons.', 'apexclinic' ),
				'all'            => false,
				'default'        => array(
					'margin-top'    => '30px',
					'margin-right'  => '30px',
			...
			array(
				...
				'type'    => 'box_shadow',
				'title'   => esc_html__( 'Theme Button Box Shadow', 'apexclinic' ),
			...
			array(
				...
				'type'           => 'typography',
				'title'          => esc_html__( 'Button Typography', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Typography options for buttons. Remember, this will effect all buttons of this theme. (Please Note: This change will effect all theme buttons, including Radiants Buttons, Radiant Contact Form Button, Radiant Fancy Text Box Button.)', 'apexclinic' ),
				'google'         => true,
				'font-backup'    => false,
				'subsets'        => false,
				'text-align'     => false,
			...
			array(
				...
				'type'     => 'color',
				'title'    => esc_html__( 'Hover Font Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select button hover font color.', 'apexclinic' ),
				'default'  => '#ffffff',
				'output'   => array(
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies only if Icon is present', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				...
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Hover Icon Color', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applies only if Icon is present', 'apexclinic' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Select Hover Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Hover Style of the "Button".', 'apexclinic' ),
				'options'  => array(
					'one'   => 'Style One (Fade)',
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Contact Form', 'apexclinic' ),
		'icon'       => 'el el-tasks',
		...
		'fields'     => array(
			...
			array(
                ...
                'units'          => array('em', 'px'),
                'units_extended' => 'false',
                'title'          => __( 'Gap For Rows', 'apexclinic' ),
				'subtitle'       => __( 'Users can change gap for rows.', 'apexclinic' ),
                'default'            => array(
                    'margin-top'     => '0px',
                    'margin-right'   => '0px',
                    'margin-bottom'  => '20px',
			...
			array(
				...
				'type'     => 'dimensions',
				'units'    => array( 'em', 'px' ),
				'title'    => __( 'Height Option for Input Fields', 'apexclinic' ),
				'subtitle' => __( 'Users can change height for Input Fields.', 'apexclinic' ),
				'width'    => false,
				'height'   => true,
				'default'  => array(
					'height' => '45',
			...
			array(
				...
				'type'     => 'dimensions',
				'units'    => array( 'em', 'px' ),
				'title'    => __( 'Height Option for Textarea Fields', 'apexclinic' ),
				'subtitle' => __( 'Users can change height for Textarea Fields.', 'apexclinic' ),
				'width'    => false,
				'height'   => true,
				'default'  => array(
					'height' => '100',
			...
			array(
				...
				'units'          => array( 'em', 'px' ),
				'units_extended' => false,
				'title'          => esc_html__( 'Padding For Input Fields Focus', 'apexclinic' ),
				'subtitle'       => esc_html__( 'Users can change padding for input fields focus.', 'apexclinic' ),
				'default'        => array(
					'padding-top'    => '0px',
					'padding-right'  => '0px',
					'padding-bottom' => '0px',
			...
			array(
				...
				'type'     => 'box_shadow',
				'title'    => esc_html__( 'Box Shadow For Input Fields', 'apexclinic' ),
				'subtitle' => esc_html__( 'Users can change the Box Shadow for input fields.', 'apexclinic' ),
				'units'    => array( '' ),
				'output'   => array(
...
Redux::setSection(
	$opt_name, array(
		'title' => esc_html__( 'Pages', 'apexclinic' ),
		'icon'  => 'el el-book',
		'id'    => 'pages-option',
	)
);
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Error 404', 'apexclinic' ),
		'icon'       => 'el el-error',
		'id'         => '404_error',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				'id'       => '404_error_style',
				'type'     => 'select',
				'title'    => esc_html__( '404 Page Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select 404 Page Style of the website.', 'apexclinic' ),
				'options'  => array(
					'one'   => 'Style One (Image and Text)',
					'two'   => 'Style Two (Image, Text and Button)',
					'three' => 'Style Three (Image, Text and Button)',
					'four'  => 'Style Four (Image and Text)',
				),
				'default'  => 'four',
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( '404 Error Style One Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( '404 Error Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for 404 Error "Style One".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( '404 Error Image', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can 404 error image for your website. (Applicable only for 404 Error "Style One".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( '404 Error Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on 404 page body. (Applicable only for 404 Error "Style One".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( '404 Error Button Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applicable only for 404 Error "Style One".', 'apexclinic' ),
				'default'  => esc_html__( 'Back To Home Page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( '404 Error Button Link', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applicable only for 404 Error "Style One".', 'apexclinic' ),
				'default'  => esc_html__( '#', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( '404 Error Style Two Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( '404 Error Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for 404 Error "Style Two".)', 'apexclinic' ),
				'default'  => array(
					'background-color'      => '#ffffff',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( '404 Error Image', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can 404 error image for your website. (Applicable only for 404 Error "Style Two".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( '404 Error Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on 404 page body. (Applicable only for 404 Error "Style Two".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( '404 Error Button Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applicable only for 404 Error "Style Two".', 'apexclinic' ),
				'default'  => esc_html__( 'Back To Home Page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( '404 Error Style Three Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( '404 Error Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for 404 Error "Style Three".)', 'apexclinic' ),
				'default'  => array(
					'background-color'      => '#ffffff',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( '404 Error Image', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can 404 error image for your website. (Applicable only for 404 Error "Style Three".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( '404 Error Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on 404 page body. (Applicable only for 404 Error "Style Three".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( '404 Error Button Text', 'apexclinic' ),
				'subtitle' => esc_html__( 'Applicable only for 404 Error "Style Three".', 'apexclinic' ),
				'default'  => esc_html__( 'Back To Home Page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( '404 Error Style Four Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( '404 Error Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for 404 Error "Style Four".)', 'apexclinic' ),
				'default'  => array(
					'background-color'      => '#ffffff',
				),
				'output'   => array(
			...
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( '404 Error Image', 'apexclinic' ),
				'subtitle' => esc_html__( 'You can 404 error image for your website. (Applicable only for 404 Error "Style Four".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( '404 Error Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on 404 page body. (Applicable only for 404 Error "Style Four".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
				'default'  => "",
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Maintenance Mode', 'apexclinic' ),
		'icon'       => 'el el-broom',
		'id'         => 'maintenance_mode',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate Maintenance Mode?', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if want to Activate Maintenance Mode.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Maintenance Mode Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Maintenance Mode Style of the website.', 'apexclinic' ),
				'options'  => array(
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Maintenance Mode Style One Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Maintenance Mode Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Maintenance Mode. (Applicable only for Maintenance Mode "Style One".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( 'Maintenance Mode Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on Maintenance Mode body. (Applicable only for Maintenance Mode "Style One".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Maintenance Mode Style Two Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Maintenance Mode Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Maintenance Mode. (Applicable only for Maintenance Mode "Style Two".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( 'Maintenance Mode Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on Maintenance Mode body. (Applicable only for Maintenance Mode "Style Two".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Maintenance Mode Style Three Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Maintenance Mode Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for Maintenance Mode. (Applicable only for Maintenance Mode "Style Three".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( 'Maintenance Mode Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on Maintenance Mode body. (Applicable only for Maintenance Mode "Style Three".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
				'default'  => "<h1>The Website Is Currently <strong>Under Construction</strong></h1><h2>Please Check Back Soon...</h2>",
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Coming Soon', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Activate Coming Soon', 'apexclinic' ),
				'subtitle' => esc_html__( 'Choose if want to activate Coming Soon mode.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Launch Date & Time', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter Launch Date & Time.', 'apexclinic' ),
			...
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Coming Soon Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Coming Soon Style of the website.', 'apexclinic' ),
				'options'  => array(
					'one'   => 'Style One',
					'two'   => 'Style Two',
					'three' => 'Style Three',
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Coming Soon Style One Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Coming Soon Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for Coming Soon "Style One".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( 'Coming Soon Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on Coming Soon page body. (Applicable only for Coming Soon "Style One".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Coming Soon Style Two Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Coming Soon Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for Coming Soon "Style Two".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( 'Coming Soon Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on Coming Soon page body. (Applicable only for Coming Soon "Style Two".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
			...
			array(
				...
				'type'  => 'info',
				'title' => esc_html__( 'Coming Soon Style Three Settings', 'apexclinic' ),
				'class' => 'radiant-subheader enable-toggle',
			),
			...
			array(
				...
				'type'     => 'background',
				'title'    => esc_html__( 'Coming Soon Background', 'apexclinic' ),
				'subtitle' => esc_html__( 'Set Background for 404 Error. (Applicable only for Coming Soon "Style Three".)', 'apexclinic' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'editor',
				'title'    => esc_html__( 'Coming Soon Content', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter content to show on Coming Soon page body. (Applicable only for Coming Soon "Style Three".)', 'apexclinic' ),
				'args'     => array(
					'teeny' => false,
				),
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Search', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				...
				'type'     => 'media',
				'url'      => false,
				'title'    => esc_html__( 'Search Page Banner Image', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select search page banner image', 'apexclinic' ),
			),

			array(
				'id'       => 'search_page_banner_title',
				'type'     => 'text',
				'title'    => esc_html__( 'Search Page Title', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter search page banner title', 'apexclinic' ),
				'default'  => 'Search',
			),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Search Page Subtitle', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter search page banner subtitle', 'apexclinic' ),
				'default'  => '',
			),
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Event', 'apexclinic' ),
		'icon'       => 'el el-calendar',
		'id'         => 'banner_layout',
		'subsection' => true,
		'fields'     => array(
			array(
				...
				'type'     => 'select',
				'title'    => esc_html__( 'Banner Details', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select Banner options', 'apexclinic' ),
				'options'  => array(
			...
			array(
				...
				'type'     => 'media',
				'url'      => false,
				'title'    => esc_html__( 'Event Banner Image', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select event banner image', 'apexclinic' ),
				'required' => array(
					array(
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Event Title', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter event banner title', 'apexclinic' ),
				'default'  => 'Events',
				'required' => array(
					array(
						'events_banner_details',
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Event Subtitle', 'apexclinic' ),
				'subtitle' => esc_html__( 'Enter event banner subtitle', 'apexclinic' ),
				'default'  => '',
				'required' => array(
					array(
						'events_banner_details',
...
Redux::setSection(
	$opt_name, array(
		'title' => esc_html__( 'Blog', 'apexclinic' ),
		'icon'  => 'el el-bullhorn',
		'id'    => 'blog',
	)
);
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Blog Layout', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				...
				'type'     => 'image_select',
				'title'    => esc_html__( 'Blog Layout', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select blog layout', 'apexclinic' ),
				'options'  => array(
					'leftsidebar'  => array(
						'alt' => 'Left Sidebar',
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Blog Options', 'apexclinic' ),
		'icon'       => 'el el-ok-sign',
		'id'         => 'blog_options',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Author Information Box', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to show author information on Blog Details Page.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Categories', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to show the categories on both Blog Page and Blog Details Page.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				'id'       => 'display_tags',
				'type'     => 'switch',
				'title'    => esc_html__( 'Tags', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to show the tags on both Blog Page and Blog Details Page.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Navigation', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to previous and next navigation the Previous/Next Navigation on Blog Details Page.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Related Article', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to show related article on Blog Details Page.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => false,
			),
			...
			array(
				...
				'type'     => 'switch',
				'title'    => esc_html__( 'Comments', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select if you want to show comments on Blog Details Page.', 'apexclinic' ),
				'on'       => esc_html__( 'Yes', 'apexclinic' ),
				'off'      => esc_html__( 'No', 'apexclinic' ),
				'default'  => true,
			),
...
Redux::setSection(
	$opt_name, array(
		'title'      => esc_html__( 'Team Details', 'apexclinic' ),
		...
		'fields'     => array(
			...
			array(
				...
				'type'     => 'image_select',
				'title'    => esc_html__( 'Team Details Style', 'apexclinic' ),
				'subtitle' => esc_html__( 'Select team details style', 'apexclinic' ),
				'options'  => array(
					'blank'   => array(
						'alt' => 'Blank',
						'img' => get_template_directory_uri() . '/inc/redux-framework/css/img/Team-Details-Style-Blank.png',
						'title' => esc_html__( 'Blank', 'apexclinic' ),
					),
					'one'   => array(
						'alt' => 'Style One',
...
if ( class_exists( 'woocommerce' ) ) {
	...
	Redux::setSection(
		$opt_name, array(
			'title' => esc_html__( 'Shop', 'apexclinic' ),
	...
	Redux::setSection(
		$opt_name, array(
			'title'      => esc_html__( 'Product Listing', 'apexclinic' ),
			'icon'       => 'el el-list-alt',
			'id'         => 'product_listing',
			'subsection' => true,
			'fields'     => array(
				...
				array(
					'id'       => 'shop-style',
					'type'     => 'image_select',
					'title'    => esc_html__( 'Product Listing Layout', 'apexclinic' ),
					'subtitle' => esc_html__( 'Select Product Listing Layout', 'apexclinic' ),
					'options'  => array(
				...
				array(
    				...
    				'type'     => 'text',
    				'title'    => esc_html__( 'Products Per Page', 'apexclinic' ),
    				'subtitle' => esc_html__( 'Put number of products you wants to show per page', 'apexclinic' ),
    				'default'  => '12',
    				'validate' => 'numeric'
			    ),
				...
				array(
					'id'       => 'shop-sidebar',
					'type'     => 'image_select',
					'title'    => esc_html__( 'Sidebar.', 'apexclinic' ),
					'subtitle' => esc_html__( 'Select Sidebar', 'apexclinic' ),
					'options'  => array(
				...
				array(
					'id'       => 'shop_box_style',
					'type'     => 'image_select',
					'title'    => esc_html__( 'Shop Box Style', 'apexclinic' ),
					'subtitle' => esc_html__( 'Select Style of the Shop Box.', 'apexclinic' ),
					'options'  => array(
						'style-one'  => array(
						    'title' => 'Overlay',
							'alt'   => 'Overlay',
	...
	Redux::setSection(
		$opt_name, array(
			'title'      => esc_html__( 'Product Details', 'apexclinic' ),
			'icon'       => 'el el-shopping-cart',
			'id'         => 'product_details',
			'subsection' => true,
			'fields'     => array(
				...
				array(
					...
					'type'     => 'image_select',
					'title'    => esc_html__( 'Product Details Layout', 'apexclinic' ),
					'subtitle' => esc_html__( 'Select Product Details Layout', 'apexclinic' ),
					'options'  => array(
						'style-one' => array(
							'alt'   => 'Style One',
...
Redux::setSection(
	$opt_name, array(
		'title'   => esc_html__( 'Social Icons', 'apexclinic' ),
		'icon'    => 'el el-globe',
		'id'      => 'social_icons',
		'submenu' => false,
		'fields'  => array(
			...
			array(
				...
				'type'    => 'switch',
				'title'   => esc_html__( 'Open links in new window', 'apexclinic' ),
				'desc'    => esc_html__( 'Open social links in new window', 'apexclinic' ),
				'default' => true,
			),
			...
			array(
				...
				'type'    => 'text',
				'title'   => esc_html__( 'Google +', 'apexclinic' ),
				'desc'    => esc_html__( 'Link to the profile page', 'apexclinic' ),
				'default' => '#',
			),
			...
			array(
				...
				'type'    => 'text',
				'title'   => esc_html__( 'Facebook', 'apexclinic' ),
				'desc'    => esc_html__( 'Link to the profile page', 'apexclinic' ),
				'default' => '#',
			),
			...
			array(
				...
				'type'    => 'text',
				'title'   => esc_html__( 'Twitter', 'apexclinic' ),
				'desc'    => esc_html__( 'Link to the profile page', 'apexclinic' ),
				'default' => '#',
			),
			...
			array(
				...
				'type'    => 'text',
				'title'   => esc_html__( 'Vimeo', 'apexclinic' ),
				'desc'    => esc_html__( 'Link to the profile page', 'apexclinic' ),
				'default' => '#',
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'YouTube', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Flickr', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'LinkedIn', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Pinterest', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				'id'    => 'social-icon-xing',
				'type'  => 'text',
				'title' => esc_html__( 'Xing', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Viadeo', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Vkontakte', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Tripadvisor', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Tumblr', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Behance', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Instagram', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Dribbble', 'apexclinic' ),
				'desc'  => esc_html__( 'Link to the profile page', 'apexclinic' ),
			),
			...
			array(
				...
				'type'  => 'text',
				'title' => esc_html__( 'Skype', 'apexclinic' ),
...
Redux::setSection(
	$opt_name, array(
		'title'   => esc_html__( 'Custom CSS', 'apexclinic' ),
		'icon'    => 'el el-css',
		...
		'fields'  => array(
			...
			array(
                ...
                'type'     => 'ace_editor',
                'title'    => esc_html__( 'Custom CSS', 'apexclinic' ),
				'subtitle' => esc_html__( 'Paste your custom CSS code here.', 'apexclinic' ),
				'mode'     => 'css',
                'theme'    => 'chrome',
            ),
